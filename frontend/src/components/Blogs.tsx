...
const renderSkeleton = () => {
  ...
  const skeletons = Array.from({ length: 5 }).map((_, index) => (
    <div
      key={index}
      className="bg-gray-800 p-6 flex flex-col w-full gap-8 animate-pulse"
    >
      <div className="bg-gray-700 h-96 md:w-3/4"></div>

      <div className="bg-gray-700 h-8 p-3 w-3/4"></div>
      <div className="flex flex-col gap-3">
      <div className="bg-gray-700 p-2 w-full"></div>
      <div className="bg-gray-700 p-2 w-full"></div>
      <div className="bg-gray-700 p-2 w-full"></div>
      <div className="bg-gray-700 p-2 w-full"></div>
      </div>
      <div className="bg-gray-700 h-6 p-4 w-1/2"></div>
      <div className="bg-gray-700 h-16 p-4 w-1/4"></div>
    </div>
  ));
  return skeletons;
};
...
const Blogs = () => {
  ...
  return (
    <div
      className="bg-black grid md:p-16 p-8 gap-8 place-items-center"
      id="blogs"
    >
