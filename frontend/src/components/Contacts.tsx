...
const Contacts = () => {
  ...
  if (state.succeeded) {
    return <p className="bg-black p-10 md:p-12 flex flex-col gap-12 md:gap-16 justify-center items-center"
    id="contact">Thanks for joining!</p>;
  }
  return (
    <div
      className="bg-black p-10 md:p-12 flex flex-col gap-12 md:gap-16 justify-center items-center"
      id="contact"
    >
      {state.succeeded ?
       <Modal />
      ...
      >
        ...
        <div className="g-recaptcha" data-sitekey="6LcnBu4oAAAAAJT2zNV3pVHXKIlL6haBuBE1h0sm"></div>
        <button
