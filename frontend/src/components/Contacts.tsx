const Contacts = () => {
  return (
    <div className="bg-black p-10 md:p-12 flex flex-col gap-12 md:gap-16 justify-center items-center" id="contact">
      <div className="text-[rgb(136,206,2)] text-5xl font-bold">Contact Us</div>
      <form action="" className="grid grid-rows-4 gap-8 md:gap-12 w-full">
        <div className="">
